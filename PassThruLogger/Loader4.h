...
//Other Functions
long WINAPI LoadJ2534Dll(const char *);
long WINAPI LoadJ2534Dll(const wchar_t *);
...
extern PTOPEN LocalOpen;
extern PTCLOSE LocalClose;
extern PTCONNECT LocalConnect;
extern PTDISCONNECT LocalDisconnect;
extern PTREADMSGS LocalReadMsgs;
extern PTWRITEMSGS LocalWriteMsgs;
extern PTSTARTPERIODICMSG LocalStartPeriodicMsg;
extern PTSTOPPERIODICMSG LocalStopPeriodicMsg;
extern PTSTARTMSGFILTER LocalStartMsgFilter;
extern PTSTOPMSGFILTER LocalStopMsgFilter;
extern PTSETPROGRAMMINGVOLTAGE LocalSetProgrammingVoltage;
extern PTREADVERSION LocalReadVersion;
